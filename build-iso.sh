...
ADDITIONAL_PACKAGES="\
    https://github.com/ChimeraOS/linux-chimeraos/releases/download/v6.10.3-chos2-1/linux-chimeraos-6.10.3.chos2-1-x86_64.pkg.tar.zst \
    https://github.com/ChimeraOS/linux-chimeraos/releases/download/v6.10.3-chos2-1/linux-chimeraos-headers-6.10.3.chos2-1-x86_64.pkg.tar.zst \
"
